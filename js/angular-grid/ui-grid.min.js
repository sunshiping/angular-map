          ...
          pre    : function (b, c, d) {
            ...
            a.i18n = {
              ...
              var b = a.col,
                  ...
                  d = c;
              return a.isSortPriorityVisible() && (d = d + ". " + a.i18n.headerCell.priority + " " + (b.sort.priority + 1)), d
          ...
          pre    : function (a, c, e, i) {
            ...
            function k(a) {
              if (!l.grid.isScrollingHorizontally) {
                var b = d.normalizeScrollLeft(m.headerViewport, l.grid), c = m.colContainer.scrollHorizontal(b),
  ...
  angular.module("ui.grid").directive("uiGridViewport", ["gridUtil", "ScrollEvent", "uiGridConstants", "$log", function (a, b, c, d) {
    return {
      ...
      link        : function (c, d, e, f) {
        function g(e) {
          var f = d[0].scrollTop, g = a.normalizeScrollLeft(d, p), h = n.scrollVertical(f), i = o.scrollHorizontal(g),
          ...
          post: function (d, e, f, g) {
            ...
            function k() {
              var a = m.options.minRowsToShow * m.options.rowHeight,
                  f = m.options.showHeader ? m.options.headerRowHeight : 0, g = m.calcFooterHeight(), h = 0;
  ...
  angular.module("ui.grid").factory("Grid", ["$q", "$compile", "$parse", "gridUtil", "uiGridConstants", "GridOptions", "GridColumn", "GridRow", "GridApi", "rowSorter", "rowSearcher", "GridRenderContainer", "$timeout", "ScrollEvent", function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
    ...
    return p.prototype.renderingComplete = function () {
      ...
      var d = this, e = new n(d, "uiGrid.scrollToIfNecessary"), f = d.renderContainers.body.visibleRowCache,
          g = d.renderContainers.body.visibleColumnCache, h = d.renderContainers.body.prevScrollTop + d.headerHeight;
      h = 0 > h ? 0 : h;
    ...
    return d.guessSortFn = function (a) {
      ...
      if (c) {
        ...
        if (e.forEach(function (a) {
            !a.sort || a.sort.ignoreSort || !a.sort.direction || a.sort.direction !== b.ASC && a.sort.direction !== b.DESC ? a.defaultSort && a.defaultSort.direction && (a.defaultSort.direction === b.ASC || a.defaultSort.direction === b.DESC) && g.push({
                col : a,
                sort: a.defaultSort
              }) : f.push({col: a, sort: a.sort})
          }), f = f.sort(d.prioritySort), g = g.sort(d.prioritySort), f = f.concat(g), 0 === f.length)return c;
        var h, i, j = function (a, b) {
          a.entity.$$uiGridIndex = b
        };
        c.forEach(j);
        var k = c.slice(0), l = function (c, e) {
          for (var g, j = 0, l = 0; 0 === j && l < f.length;) {
            h = f[l].col, i = f[l].sort.direction, g = d.getSortFn(a, h, k);
            var m, n;
            h.sortCellFiltered ? (m = a.getCellDisplayValue(c, h), n = a.getCellDisplayValue(e, h)) : (m = a.getCellValue(c, h), n = a.getCellValue(e, h)), j = g(m, n, c, e, i, h), l++
          }
          return 0 === j ? c.entity.$$uiGridIndex - e.entity.$$uiGridIndex : i === b.ASC ? j : 0 - j
        }, m  = c.sort(l), n = function (a, b) {
        ...
        return {
          post: function (a, b, e, f) {
            if (a.col.colDef.enableColumnMoving) {
              var h, i, j, k, l, m, n = angular.element(b[0].querySelectorAll(".ui-grid-cell-contents")), o = !1,
                  p = !1, q = function (b) {
    ...
    var f = {
      initializeGrid          : function (a, b) {
        ...
        b.api.registerEventsFromObject(c.events),
          b.api.registerMethodsFromObject(c.methods), b.api.core.on.renderingComplete(a, function (c) {
  ...
  a.constant("uiGridSaveStateConstants", {featureName: "saveState"}), a.service("uiGridSaveStateService", ["$q", "uiGridSaveStateConstants", "gridUtil", "$compile", "$interval", "uiGridConstants", function (a, b, c, d, e, f) {
    var g = {
      initializeGrid       : function (a) {
        ...
        return c.columns && g.restoreColumns(a, c.columns), c.scrollFocus && g.restoreScrollFocus(a, b, c.scrollFocus), c.selection && g.restoreSelection(a, c.selection), c.grouping && g.restoreGrouping(a, c.grouping), c.treeView && g.restoreTreeView(a, c.treeView), c.pagination && g.restorePagination(a, c.pagination), a.refresh()
