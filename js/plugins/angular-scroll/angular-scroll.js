    ...
    var createScrollHandler = function (context) {
      ...
      var handler = function () {
        ...
        for (i = 0; i < spies.length; i++) {
          ...
          if (!pos) continue;
          if ((duScrollBottomSpy && bottomReached) || (pos.top + spy.offset - containerOffset < 20 && (pos.top * -1 + containerOffset) < pos.height)) {
        ...
        if (currentlyActive) {
          ...
          currentlyActive.target.className = toBeActive.target.className;
          $rootScope.$broadcast(
        ...
        if (toBeActive) {
          ...
          toBeActive.target.className = toBeActive.target.className + " " + 'active';
          $rootScope.$broadcast(
    ...
    return {
      link: function ($scope, $element, $attr) {
        ...
        $element.on('click', function (e) {
          ...
          angular.element("#" + id).addClass('active').siblings().removeClass('active');
