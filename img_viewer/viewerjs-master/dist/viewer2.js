...
// e.g.: http://domain.com/path/to/picture.jpg?size=1280×960 -> picture.jpg
  ...
  function getTransform(data) {
    ...
    return transforms.length ? transforms.join(' ') : val;
  }
  ...
  var render$1 = {
    ...
    initImage: function initImage(callback) {
      ...
      if (self.images[self.index].dataset.rotate) {
        self.imageData = {
          rotate: parseInt(self.images[self.index].dataset.rotate)
        }
      }
    ...
    renderImage: function renderImage(callback) {
      ...
      // imageData.rotate = self.images[this.index].dataset.rotate;
...
// Events
  ...
  var methods = {
    ...
    rotate: function rotate(degree) {
      ...
      addListener(element, 'imgRotate', function () {
        debugger;
      }, true);
      return self;
    },
